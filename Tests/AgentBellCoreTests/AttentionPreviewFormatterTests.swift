...
final class AttentionPreviewFormatterTests: XCTestCase {
    func testApprovalPreviewUsesSurfaceToolAndRelativeFile() {
        ...
        XCTAssertEqual(preview, "Codex Desktop wants to read_file: README.md")
    }
    ...
    func testCommandPreviewUsesVSCodeSurfaceAndRedactsSecrets() {
        ...
        XCTAssertEqual(
            preview,
            "Claude Code VS Code wants to run_command: API_TOKEN=•••• npx install ccusage@latest --password ••••"
        )
    ...
    func testQuestionPreviewContainsOnlyFirstQuestion() {
        ...
        XCTAssertEqual(preview, "Does this work?")
    ...
    func testExitPlanModeUsesGenericReviewActionWithoutPlanContent() {
        ...
        XCTAssertEqual(
            preview,
            "Claude Code CLI wants to exit_plan_mode: Review the proposed plan"
        )
    ...
    func testMCPAndSearchToolNamesAreNormalized() {
        ...
        XCTAssertEqual(
            ...
            "Codex CLI wants to read_file: Sources/App.swift"
        )
        XCTAssertEqual(
            AttentionPreviewFormatter.preview(
                provider: .claude,
            ...
            "Claude Code CLI wants to search_text: Needs attention in Sources"
        )
    }
    ...
    func testUnknownToolDoesNotSerializeUnrelatedInput() {
        ...
        XCTAssertEqual(preview, "Codex CLI wants to custom_magic_tool")
    ...
    func testOutsideProjectPathUsesOnlyBasename() {
        ...
        XCTAssertEqual(preview, "Claude Code CLI wants to write_file: secrets.txt")
    }

...
final class NtfyOutboxTests: XCTestCase {
    ...
    func testLegacyPlaintextTopicIsRemovedWhenOutboxLoads() throws {
        ...
        deliveries[0]["topic"] =
            "agentbell-legacy-plaintext-topic-secret"
    ...
    func testDuplicatePersistedIDsKeepNewestWithoutCrashing() throws {
        ...
        var older = makeDelivery(id: "agentbell-duplicate", date: now - 100)
        var newer = older
    ...
    private func temporaryDirectory() -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("AgentBellNtfyTests-\(UUID().uuidString)")

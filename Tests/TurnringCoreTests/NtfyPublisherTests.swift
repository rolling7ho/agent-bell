...
final class NtfyPublisherTests: XCTestCase {
    func testSecureTopicUsesTwoHundredFiftySixBitsOfDeterministicEntropy() throws {
        ...
        XCTAssertEqual(
            topic,
            "turnring-AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8"
        )
        XCTAssertNil(
    ...
    func testOnlyFullGeneratedTopicsCanBeMigrated() {
        ...
        XCTAssertNil(
            SecureNtfyTopic.migratableTopic(
                "turnring-0123456789abcdef0123456789abcdef"
    ...
    func testBuildsHTTPSJSONRequestWithoutRoutingMetadata() throws {
        let message = NtfyMessage(
            ...
            message: "Codex Desktop wants permission to read a file: README.md.",
            priority: .high,
            tags: ["bell", "warning"],
            sequenceID: "turnring-sequence-123"
        )

        let request = try NtfyRequestBuilder.makeRequest(
            serverURL: "https://ntfy.sh",
            topic: "turnring-0123456789abcdef0123456789abcdef",
            message: message
        )
        ...
        XCTAssertEqual(payload["sequence_id"] as? String, "turnring-sequence-123")
    ...
    func testAccessTokenUsesAuthorizationHeaderAndNeverURLOrBody() throws {
        ...
        let request = try NtfyRequestBuilder.makeRequest(
            serverURL: "https://ntfy.sh",
            topic: "turnring-0123456789abcdef",
            message: message,
            accessToken: token
        )
    ...
    func testRejectsInsecureOrCredentialedServerURLs() {
        ...
        let topic = "turnring-0123456789abcdef"
    ...
    func testRejectsShortOrUnsafeTopics() {
        ...
        XCTAssertFalse(NtfyRequestBuilder.isValidTopic("turnring/topic with spaces"))
        XCTAssertFalse(
        ...
        XCTAssertTrue(
            NtfyRequestBuilder.isValidTopic("turnring-0123456789abcdef")
        )
    }
    ...
    func testMessageCollapsesWhitespaceAndTruncatesUnicodeSafely() {
        ...
        XCTAssertEqual(message.title, "Turnring phone test")
    ...
    func testOpaqueSequenceIDIsStableAndDoesNotExposeInput() {
        ...
        XCTAssertTrue(first.hasPrefix("turnring-"))

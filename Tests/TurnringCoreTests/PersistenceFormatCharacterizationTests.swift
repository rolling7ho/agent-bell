...
final class PersistenceFormatCharacterizationTests: XCTestCase {
    func testEventQueueEncodingKeepsCurrentKeysAndExcludesUnmodeledInput() throws {
        ...
        let event = AgentEvent(
            ...
            contentPreview: "Codex CLI wants permission to run a command: swift test.",
    ...
    func testSessionStoreKeepsVersionFourEnvelopeAndCurrentSummaryKeys() throws {
        let directory = temporaryDirectory()
    ...
    func testNtfyOutboxKeepsVersionTwoSecretFreeEnvelope() throws {
        ...
        let delivery = NtfyDelivery(
            ...
            message: NtfyMessage(
                ...
                priority: .high,
                tags: ["bell"],
                sequenceID: "turnring-schema-delivery"
            ),
            surfaceKey: "codexCLI",
            state: .attention,
    ...
    private func temporaryDirectory() -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent(
                "TurnringPersistenceCharacterization-\(UUID().uuidString)",
                isDirectory: true
            )

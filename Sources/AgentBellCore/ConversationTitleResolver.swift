...
public struct ConversationTitleResolver: Sendable {
    ...
    public init(homeDirectory: URL = AgentBellPaths.homeDirectory) {
    ...
    public func title(
        ...
        guard AgentBellValidation.isValidSessionID(sessionID) else { return nil }
        switch provider {
        case .codex:
    ...
    private func normalizedTitle(_ value: String?) -> String? {
        ...
        let normalized = AgentBellSafeText.redacted(

...
public enum EventQueue {
    ...
    public static func append(_ event: AgentEvent, to url: URL = AgentBellPaths.queueFile) throws {
    ...
    public static func claim(
        from url: URL = AgentBellPaths.queueFile,
    ...
    public static func drain(from url: URL = AgentBellPaths.queueFile) throws -> [AgentEvent] {
